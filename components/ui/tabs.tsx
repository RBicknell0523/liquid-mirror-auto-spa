    ...
    return (
      <div ref={ref} className={cn("relative", className)} {...props}>
        <div className="relative">
          {/* Hover highlight */}
          <div
            className="absolute h-[30px] transition-all duration-300 ease-out bg-hover-subtle rounded-[6px]"
            style={{
              ...hoverStyle,
          ...
          {/* Active indicator */}
          <div
            className="absolute bottom-[-6px] h-[2px] bg-electric-gradient transition-all duration-300 ease-out"
            style={activeStyle}
          />
